...
final class WorldView
{
   ...
   private int winScreenFrame = 1;
   public static PImage restartImage;

   private long next_time = 100;
   private int timerActionPeriod = 200;
   ...
   public void drawRestart() {
      if (restartImage != null) {
         this.screen.image(restartImage, 20,
                 20);
      }
   }
   ...
   public void drawWin() {
      if (winScreen != null) {
         ...
         this.screen.image(winScreen, 500,
                 330);
         if (time >= next_time)
         {
            winScreen = world.getScreen().loadImage("images/winScreen" + winScreenFrame + ".png");

            winScreenFrame += 1;
            if (winScreenFrame > 4) {
               winScreenFrame = 1;
            }
            next_time = time + timerActionPeriod;
         }
   ...
   public void drawEntities()
   {
      ...
      for (Entity entity : this.world.getHigherEntities())
      {
         Point pos = entity.getPosition();
